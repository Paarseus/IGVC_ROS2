...
- [x] ~~5 m straight-line `m_per_rev` calibration.~~ **Done 2026-05-28** (12 s @ 0.35 m/s on asphalt, tape-confirmed pass of 3 m mark, EKF=3.84 m, wheel_odom=3.86 m, all within slew-loss margin of commanded 4.20 m). `m_per_rev = 0.01994` confirmed correct. See `docs/yaw_diag_session_2026_05_28/validation_results.md`.
